...
export const ProfileScreen = () => {
    ...
    return (
      <>
        ...
        <View style={{ ...defaultStyles.row, alignSelf: "stretch" }}>
          <Text style={{ ...defaultStyles.text, flexGrow: 1 }}>
            {user[fieldName] || "Not yet defined"}
          </Text>
          <Button
            title="Edit"
            onPress={() => {
  ...
  return (
    <View style={defaultStyles.container}>
      ...
      <Text style={{ ...defaultStyles.text, alignSelf: "stretch" }}>
        {user.username}
      </Text>
